...
class APIResponse
{
     ...
     *
     * @see APIResponse::getInstance() Actual instantiation happens here
     */
    ...
    public static function verifyAuth(bool $authRequired): ?string
    {
        ...
        if(!is_null($authToken)) {
            $ssoClient = new Client(Environment::get('APP_TOKEN'));
            ...
            try {
                ...
                $response->addError(999101)->render();
            }
